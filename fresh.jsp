...
<%
	...
	ResultSet rs = st.executeQuery("SELECT * FROM question WHERE askedon >= DATE_ADD(CURDATE(), INTERVAL -2 DAY) ORDER BY RAND()  LIMIT 1");
	rs.next();
...
<div id="Quest" style="padding-bottom:0px;height:450px;">
    ...
    <input type="hidden" name="src" value="fresh.jsp"  />
