...
<%@ page contentType="text/html; charset=utf-8" language="java" import="java.sql.*" errorPage="nosearch.jsp" %>
<%
...
<%
	...
	ResultSet rs = st.executeQuery("SELECT * FROM question where keyword like \"%"+search+"%\" ORDER BY RAND()  LIMIT 1");
	rs.next();
...
<div id="Quest" style="padding-bottom:0px;height:450px;">
    ...
    <input type="hidden" name="src" value="search.jsp"  />
    <input type="hidden" name="sbox" value="<%=search%>"  />
